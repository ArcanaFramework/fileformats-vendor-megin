...
.. image:: https://codecov.io/gh/arcanaframework/fileformats-vendor-megin-extras/branch/main/graph/badge.svg?token=UIS0OGPST7
    :target: https://codecov.io/gh/arcanaframework/fileformats-vendor-megin-extras
.. image:: https://img.shields.io/github/stars/ArcanaFramework/fileformats-vendor-megin-extras.svg
    :alt: GitHub stars
...
`fileformats-vendor-megin <https://github.com/ArcanaFramework/fileformats-vendor-megin>`__ package, which provides
...
This extension can be installed for Python 3 using *pip*::
    ...
    $ pip3 install fileformats-vendor-megin-extras
